...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 02, 2026 at 10:11 PM
...
(32, 3, 2, 81, 'BOOKING_CHARGE', 110.00, 'Charge for booking BKG-BF594A9C031E', '2026-09-02 13:50:06'),
(33, 4, 2, 75, 'CANCELLATION_CREDIT', -150.00, 'University Admin cancellation credit for BKG-521B3FE2', '2026-09-02 16:44:05'),
(34, 3, 2, 82, 'BOOKING_CHARGE', 110.00, 'Charge for booking BKG-D8EE4A8A1EA6', '2026-09-02 17:19:46'),
(35, 7, 2, 83, 'BOOKING_CHARGE', 110.00, 'Charge for booking BKG-392A12E7B8B9', '2026-09-02 18:42:43'),
(36, 2, 2, 84, 'BOOKING_CHARGE', 110.00, 'Charge for booking BKG-3CC9365C3362', '2026-09-02 19:36:28');
...
(75, 'BKG-521B3FE2', 4, 9, 'SEAT', 20, NULL, 150.00, '521b3ffd-a157-11f1-b03f-e0d55ee5bc15', 'CANCELLED', '2026-08-26 14:06:22', '2026-08-26 14:06:22', 0),
...
(81, 'BKG-BF594A9C031E', 3, 14, 'SEAT', 16, NULL, 110.00, '7b82f36ac401ad8f44d9a82b6ff56021e775d619cb6f2cbf0891c773a83a7a68', 'CANCELLED', '2026-09-02 13:50:06', '2026-09-02 13:50:06', 0),
(82, 'BKG-D8EE4A8A1EA6', 3, 14, 'SEAT', 4, NULL, 110.00, '8c3d0e63c2aad1315dec2d455f6c4c89b680587389377a432241b1b4fccfd7ec', 'BOOKED', '2026-09-02 17:19:46', '2026-09-02 17:19:46', 0),
(83, 'BKG-392A12E7B8B9', 7, 15, 'SEAT', 3, NULL, 110.00, 'aa728d05d31f00b3718d94808dad838faf3a6cc84cde25778dc42e28bb03ce5f', 'CANCELLED', '2026-09-02 18:42:43', '2026-09-02 18:42:43', 0),
(84, 'BKG-3CC9365C3362', 2, 18, 'SEAT', 19, NULL, 110.00, 'ec77c0eb4a9d21a32ddbd6d1b5888580433890bff71d71a30c19c5febe43cd81', 'CANCELLED', '2026-09-02 19:36:28', '2026-09-02 19:36:28', 0);
...
(33, 81, NULL, 'BOOKED', 'PASSENGER', '2026-09-02 13:50:06'),
(34, 75, 'BOOKED', 'CANCELLED', 'UNIVERSITY_ADMIN', '2026-09-02 16:44:05'),
(35, 82, NULL, 'BOOKED', 'PASSENGER', '2026-09-02 17:19:46'),
(36, 83, NULL, 'BOOKED', 'PASSENGER', '2026-09-02 18:42:43'),
(37, 84, NULL, 'BOOKED', 'PASSENGER', '2026-09-02 19:36:28');
...
(8, 1, 'Bs-3211223', '12312312431', 40, 10, 'STUDENT_ONLY', 'ACTIVE', '2026-09-02 12:57:21'),
(9, 2, 'Bs-32113344444', '65362452', 40, 10, 'STUDENT_ONLY', 'ACTIVE', '2026-09-02 17:43:12'),
(10, 2, 'Bs-321122222', '123123125115', 40, 10, 'STUDENT_ONLY', 'ACTIVE', '2026-09-02 18:25:17'),
(11, 1, 'Bs-32113344222', '653624544', 40, 10, 'STUDENT_ONLY', 'ACTIVE', '2026-09-02 18:44:47'),
(12, 1, 'Bs-3211233333', '1231231240000', 40, 10, 'STUDENT_ONLY', 'ACTIVE', '2026-09-02 19:32:51'),
(13, 1, 'Bs-32112230000', '6536245222222', 40, 10, 'STUDENT_ONLY', 'ACTIVE', '2026-09-02 19:33:33');
...
CREATE TABLE `bus_route_assignments` (
  ...
  `active_bus_key` int(11) DEFAULT NULL COMMENT 'Mirrors bus_id only for the active assignment',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `bus_route_assignments` (`assignment_id`, `bus_id`, `route_id`, `is_active`, `active_bus_key`, `created_at`) VALUES
(1, 1, 1, 1, 1, '2026-08-19 14:38:27'),
(2, 1, 2, 0, NULL, '2026-08-19 14:38:27'),
(3, 2, 3, 1, 2, '2026-08-19 14:38:27'),
(4, 3, 4, 1, 3, '2026-08-19 14:38:27'),
(5, 5, 6, 1, 5, '2026-08-19 14:38:27'),
(6, 6, 7, 1, 6, '2026-08-19 14:38:27'),
(7, 7, 8, 1, 7, '2026-09-02 12:52:20'),
(8, 9, 10, 1, 9, '2026-09-02 17:44:55'),
(9, 10, 12, 1, 10, '2026-09-02 18:28:53'),
(10, 13, 14, 1, 13, '2026-09-02 19:35:25');
...
(1, 3, 'Booking Confirmed', 'Your booking BKG-417539E6 is confirmed.', 'BOOKING', 0, 1, NULL, '2026-08-25 18:39:07'),
(2, 3, 'Booking Confirmed', 'Your booking BKG-19D40DC2 is confirmed.', 'BOOKING', 0, 1, NULL, '2026-08-25 18:45:10'),
(3, 3, 'Booking Cancelled', 'Your booking has been cancelled successfully.', 'BOOKING', 0, 1, NULL, '2026-08-25 19:13:37'),
(4, 3, 'Booking Confirmed', 'Your booking BKG-21D7E455 is confirmed.', 'BOOKING', 0, 1, NULL, '2026-08-25 19:14:02'),
(5, 3, 'Booking Confirmed', 'Your booking BKG-2B2131D8 is confirmed.', 'BOOKING', 0, 1, NULL, '2026-08-25 19:14:17'),
...
(32, 3, 'Booking Confirmed', 'Your booking BKG-BF594A9C031E is confirmed at BDT 110.00.', 'BOOKING', 81, 0, NULL, '2026-09-02 13:50:06'),
(33, 4, 'Booking Cancelled', 'Your booking BKG-521B3FE2 for R-101 — BRACU - Uttara Express on 2026-08-26 at 2:30 PM was cancelled by your University Admin. Reason: not available Review My Bookings for the updated status.', 'BOOKING', 75, 0, NULL, '2026-09-02 16:44:05'),
(34, 3, 'Booking Confirmed', 'Your booking BKG-D8EE4A8A1EA6 is confirmed at BDT 110.00.', 'BOOKING', 82, 0, NULL, '2026-09-02 17:19:46'),
(35, 2, 'New sign-in detected', 'A sign-in from a new device or network was recorded. Review your active sessions if this was not you.', 'SECURITY', NULL, 0, NULL, '2026-09-02 17:50:54'),
(36, 7, 'Booking Confirmed', 'Your booking BKG-392A12E7B8B9 is confirmed at BDT 110.00.', 'BOOKING', 83, 0, NULL, '2026-09-02 18:42:43'),
(37, 2, 'Booking Confirmed', 'Your booking BKG-3CC9365C3362 is confirmed at BDT 110.00.', 'BOOKING', 84, 0, NULL, '2026-09-02 19:36:28');
...
(9, 1, 'R-102', 'Campus-Dhanmondi', 'Campus', 'Science lab', 110.00, 'ACTIVE', '2026-09-02 13:00:09'),
(10, 2, 'R-103', 'Campus-Jigatola', 'Campus', 'Jigatola', 110.00, 'ACTIVE', '2026-09-02 17:43:37'),
(11, 2, 'NSU-103', 'Campus-mirpur', 'Campus', 'mirpur 1', 110.00, 'ACTIVE', '2026-09-02 18:22:16'),
(12, 2, 'R-106', 'Campus-kalabagan', 'Campus', 'kalabagan', 110.00, 'ACTIVE', '2026-09-02 18:26:32'),
(13, 1, 'R-107', 'Campus-Jigatola', 'Campus', 'Jigatola', 110.00, 'ACTIVE', '2026-09-02 18:44:26'),
(14, 1, 'R-108', 'Campus-Uttara', 'Campus', 'uttara', 110.00, 'ACTIVE', '2026-09-02 19:34:12');
...
CREATE TABLE `route_stops` (
  ...
  `stop_order` int(11) NOT NULL COMMENT '1 = origin, ascending along the route',
...
CREATE TABLE `schedules` (
  ...
  `shift_name` enum('NOON','EVENING') DEFAULT NULL,
...
INSERT INTO `schedules` (`schedule_id`, `route_id`, `bus_id`, `schedule_date`, `shift_name`, `departure_time`, `arrival_time`, `status`, `created_at`) VALUES
(1, 1, 1, '2026-08-26', NULL, '17:20:00', '18:50:00', 'SCHEDULED', '2026-08-19 14:38:27'),
(2, 2, 1, '2026-08-26', NULL, '17:20:00', '18:30:00', 'SCHEDULED', '2026-08-19 14:38:27'),
(3, 3, 2, '2026-08-26', NULL, '17:20:00', '18:20:00', 'SCHEDULED', '2026-08-19 14:38:27'),
(4, 4, 3, '2026-08-26', NULL, '17:20:00', '18:45:00', 'SCHEDULED', '2026-08-19 14:38:27'),
(5, 5, 1, '2026-08-27', NULL, '19:30:00', '20:40:00', 'SCHEDULED', '2026-08-19 14:38:27'),
(6, 6, 5, '2026-08-27', NULL, '17:00:00', '18:00:00', 'SCHEDULED', '2026-08-19 14:38:27'),
(7, 7, 6, '2026-08-27', NULL, '17:15:00', '18:15:00', 'SCHEDULED', '2026-08-19 14:38:27'),
(8, 8, 7, '2026-08-26', NULL, '10:00:00', '11:30:00', 'SCHEDULED', '2026-08-25 14:44:28'),
(9, 8, 7, '2026-08-26', NULL, '14:30:00', '16:00:00', 'SCHEDULED', '2026-08-25 14:44:28'),
(10, 8, 7, '2026-08-27', NULL, '08:00:00', '09:30:00', 'SCHEDULED', '2026-08-25 14:44:28'),
(11, 4, 3, '2026-09-02', 'NOON', '14:00:00', '15:25:00', 'SCHEDULED', '2026-09-02 13:30:47'),
(12, 3, 2, '2026-09-02', 'EVENING', '17:10:00', '18:10:00', 'SCHEDULED', '2026-09-02 13:33:40'),
(14, 8, 7, '2026-09-03', 'NOON', '14:00:00', '15:30:00', 'SCHEDULED', '2026-09-02 13:49:28'),
(15, 10, 9, '2026-09-03', 'EVENING', '17:10:00', '18:10:00', 'SCHEDULED', '2026-09-02 17:45:31'),
(16, 4, 3, '2026-09-03', 'EVENING', '17:10:00', '18:35:00', 'SCHEDULED', '2026-09-02 17:49:58'),
(17, 12, 10, '2026-09-03', 'NOON', '14:00:00', '15:00:00', 'SCHEDULED', '2026-09-02 18:29:03'),
(18, 14, 13, '2026-09-03', 'EVENING', '17:10:00', '18:10:00', 'SCHEDULED', '2026-09-02 19:35:36');

--
-- Triggers `schedules`
--
DELIMITER $$
CREATE TRIGGER `trg_schedule_fixed_shift_insert` BEFORE INSERT ON `schedules` FOR EACH ROW BEGIN
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_schedule_fixed_shift_update` BEFORE UPDATE ON `schedules` FOR EACH ROW BEGIN
    DECLARE v_assignment_count INT DEFAULT 0;
    DECLARE v_conflict_count INT DEFAULT 0;
...
INSERT INTO `semester_bills` (`bill_id`, `passenger_id`, `semester_id`, `university_id`, `total_charges`, `net_balance`, `status`, `created_at`, `updated_at`, `total_credits`) VALUES
(1, 3, 1, 1, 270.00, 270.00, 'OPEN', '2026-08-25 18:39:07', '2026-09-02 12:58:20', 0.00),
(3, 3, 2, 1, 640.00, 640.00, 'OPEN', '2026-08-25 19:14:02', '2026-09-02 17:19:46', 0.00),
(6, 4, 2, 1, 2830.00, 2680.00, 'OPEN', '2026-08-25 19:17:56', '2026-09-02 16:44:05', 150.00),
(7, 2, 2, 1, 660.00, 660.00, 'OPEN', '2026-08-26 16:30:41', '2026-09-02 19:36:28', 0.00),
(14, 7, 2, 2, 110.00, 110.00, 'OPEN', '2026-09-02 18:42:43', '2026-09-02 18:42:43', 0.00);

--
-- Triggers `semester_bills`
--
DELIMITER $$
CREATE TRIGGER `trg_semester_bills_set_university` BEFORE INSERT ON `semester_bills` FOR EACH ROW SET NEW.`university_id` = (
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_semester_bills_sync_university_update` BEFORE UPDATE ON `semester_bills` FOR EACH ROW SET NEW.`university_id` = (
        SELECT `p`.`university_id`
        FROM `passengers` `p`
        WHERE `p`.`passenger_id` = NEW.`passenger_id`
    )
...
(259, 'SYSTEM_ADMIN', 1, '01728167993', '14 west and street,central road,Dhanmondi,Dhaka-1205', '1999-02-15', 'MALE', 'jamal', '01728167993', NULL, NULL, NULL, 'NO_PREFERENCE', NULL, NULL, NULL, NULL, '2026-08-26 16:42:06', '2026-09-02 17:38:42');
...
(17, 'SYSTEM_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 19:29:50'),
(18, 'SYSTEM_ADMIN', 1, 'SUSPICIOUS_LOGIN', 'A sign-in from a new device or network was detected.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 19:29:50'),
(19, 'SYSTEM_ADMIN', 1, 'ADMIN_ACTION', 'East West University was created with its first University Admin. The complete shared dashboard and all role features are available immediately.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 19:37:18'),
(20, 'SYSTEM_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 19:39:33'),
(21, 'SYSTEM_ADMIN', 1, 'ADMIN_ACTION', 'Administrator status updated.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 19:39:56'),
(22, 'SYSTEM_ADMIN', 1, 'ADMIN_ACTION', 'Administrator status updated.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 19:40:05'),
(23, 'SYSTEM_ADMIN', 1, 'PROFILE_UPDATED', 'Personal profile information was updated.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 21:28:45'),
(24, 'SYSTEM_ADMIN', 1, 'PROFILE_UPDATED', 'Personal profile information was updated.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 21:28:58'),
(25, 'SYSTEM_ADMIN', 1, 'LOGIN_FAILED', 'An unsuccessful sign-in attempt was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 22:22:17'),
(26, 'SYSTEM_ADMIN', 1, 'LOGIN_FAILED', 'An unsuccessful sign-in attempt was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 22:22:21'),
(27, 'SYSTEM_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 22:22:33'),
(28, 'SYSTEM_ADMIN', 1, 'UNIVERSITY_DELETED', 'Permanently deleted university 158109 (East West University).', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 22:23:40'),
(29, 'SYSTEM_ADMIN', 1, 'ADMIN_ACTION', 'East West University was created with its first University Admin. The complete shared dashboard and all role features are available immediately.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 22:27:29'),
(30, 'SYSTEM_ADMIN', 1, 'UNIVERSITY_DELETED', 'Permanently deleted university EWU (East West University).', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 22:28:07'),
(31, 'SYSTEM_ADMIN', 1, 'PROFILE_UPDATED', 'Personal profile information was updated.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 22:28:36'),
(32, 'SYSTEM_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 22:40:26'),
(33, 'SYSTEM_ADMIN', 1, 'ADMIN_ACTION', 'East West University was created with its first University Admin. The complete shared dashboard and all role features are available immediately.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 22:58:21'),
(34, 'SYSTEM_ADMIN', 1, 'UNIVERSITY_ADMIN_DELETED', 'Permanently deleted University Administrator ewu.transport@gmail.com.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 22:58:53'),
(35, 'SYSTEM_ADMIN', 1, 'UNIVERSITY_DELETED', 'Permanently deleted university EWU (East West University).', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-01 22:59:06'),
(36, 'SYSTEM_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 01:18:44'),
(37, 'SYSTEM_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 01:40:26'),
(38, 'SYSTEM_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 01:42:34'),
(39, 'PASSENGER', 3, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 11:38:41'),
(40, 'SYSTEM_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 11:45:36'),
(41, 'PASSENGER', 3, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 12:51:31'),
(42, 'UNIVERSITY_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 12:55:02'),
(43, 'UNIVERSITY_ADMIN', 1, 'SUSPICIOUS_LOGIN', 'A sign-in from a new device or network was detected.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 12:55:02'),
(44, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Bus added to BRAC University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 12:57:21'),
(45, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Route added to BRAC University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:00:09'),
(46, 'PASSENGER', 3, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:01:26'),
(47, 'UNIVERSITY_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:25:56'),
(48, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Noon schedule created for BRAC University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:30:47'),
(49, 'PASSENGER', 6, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:31:14'),
(50, 'UNIVERSITY_ADMIN', 1, 'LOGIN_FAILED', 'An unsuccessful sign-in attempt was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:33:00'),
(51, 'UNIVERSITY_ADMIN', 1, 'LOGIN_FAILED', 'An unsuccessful sign-in attempt was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:33:16'),
(52, 'UNIVERSITY_ADMIN', 1, 'LOGIN_FAILED', 'An unsuccessful sign-in attempt was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:33:22'),
(53, 'UNIVERSITY_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:33:29'),
(54, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Evening schedule created for BRAC University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:33:40'),
(55, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Noon schedule created for BRAC University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:37:09'),
(56, 'PASSENGER', 3, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:37:27'),
(57, 'UNIVERSITY_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:48:33'),
(58, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Noon schedule created for BRAC University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:49:28'),
(59, 'PASSENGER', 3, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 13:49:56'),
(60, 'PASSENGER', 3, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 15:08:14'),
(61, 'UNIVERSITY_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 15:14:47'),
(62, 'SYSTEM_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 15:19:39'),
(63, 'UNIVERSITY_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 16:43:15'),
(64, 'UNIVERSITY_ADMIN', 1, 'BOOKING_CANCELLED', 'Cancelled booking BKG-521B3FE2 for passenger Tanvir Hasan in university 1. Reason: not available', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 16:44:05'),
(65, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Booking BKG-521B3FE2 was cancelled and the passenger was notified.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 16:44:05'),
(66, 'PASSENGER', 3, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 16:45:51'),
(67, 'SYSTEM_ADMIN', 1, 'LOGIN_FAILED', 'An unsuccessful sign-in attempt was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 16:46:21'),
(68, 'SYSTEM_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 16:46:28'),
(69, 'PASSENGER', 3, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:05:31'),
(70, 'UNIVERSITY_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:06:19'),
(71, 'UNIVERSITY_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:09:56'),
(72, 'SYSTEM_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:10:19'),
(73, 'PASSENGER', 3, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:18:44'),
(74, 'SYSTEM_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:35:08'),
(75, 'SYSTEM_ADMIN', 1, 'ADMIN_ACTION', 'East West University was created with its first University Admin. The complete shared dashboard and all role features are available immediately.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:37:18'),
(76, 'SYSTEM_ADMIN', 1, 'UNIVERSITY_ADMIN_DELETED', 'Permanently deleted University Administrator ewu.transport@gmail.com.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:37:39'),
(77, 'SYSTEM_ADMIN', 1, 'UNIVERSITY_DELETED', 'Permanently deleted university EWU (East West University).', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:37:48'),
(78, 'SYSTEM_ADMIN', 1, 'PROFILE_UPDATED', 'Personal profile information was updated.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:38:15'),
(79, 'SYSTEM_ADMIN', 1, 'PROFILE_PICTURE_UPDATED', 'The profile picture was replaced.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:38:37'),
(80, 'SYSTEM_ADMIN', 1, 'PROFILE_PICTURE_REMOVED', 'The profile picture was removed.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:38:42'),
(81, 'UNIVERSITY_ADMIN', 2, 'LOGIN_FAILED', 'An unsuccessful sign-in attempt was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:39:09'),
(82, 'UNIVERSITY_ADMIN', 2, 'LOGIN_FAILED', 'An unsuccessful sign-in attempt was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:39:25'),
(83, 'UNIVERSITY_ADMIN', 2, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:40:03'),
(84, 'UNIVERSITY_ADMIN', 2, 'ADMIN_ACTION', 'Bus added to North South University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:43:12'),
(85, 'UNIVERSITY_ADMIN', 2, 'ADMIN_ACTION', 'Route added to North South University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:43:37'),
(86, 'UNIVERSITY_ADMIN', 2, 'ADMIN_ACTION', 'Bus #9 was assigned to its route.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:44:55'),
(87, 'UNIVERSITY_ADMIN', 2, 'ADMIN_ACTION', 'Evening schedule created for North South University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:45:31'),
(88, 'PASSENGER', 8, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:47:20'),
(89, 'UNIVERSITY_ADMIN', 2, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:47:58'),
(90, 'PASSENGER', 8, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:48:34'),
(91, 'UNIVERSITY_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:49:40'),
(92, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Evening schedule created for BRAC University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:49:58'),
(93, 'PASSENGER', 2, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:50:54'),
(94, 'PASSENGER', 2, 'SUSPICIOUS_LOGIN', 'A sign-in from a new device or network was detected.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 17:50:54'),
(95, 'UNIVERSITY_ADMIN', 2, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:20:44'),
(96, 'UNIVERSITY_ADMIN', 2, 'ADMIN_ACTION', 'Route added to North South University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:22:16'),
(97, 'PASSENGER', 8, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:23:02'),
(98, 'UNIVERSITY_ADMIN', 2, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:23:37'),
(99, 'UNIVERSITY_ADMIN', 2, 'ADMIN_ACTION', 'Bus added to North South University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:25:17'),
(100, 'UNIVERSITY_ADMIN', 2, 'ADMIN_ACTION', 'Route added to North South University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:26:32'),
(101, 'UNIVERSITY_ADMIN', 2, 'ADMIN_ACTION', 'Bus #10 was assigned to its route.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:28:53'),
(102, 'UNIVERSITY_ADMIN', 2, 'ADMIN_ACTION', 'Noon schedule created for North South University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:29:03'),
(103, 'PASSENGER', 8, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:29:20'),
(104, 'PASSENGER', 7, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:42:26'),
(105, 'UNIVERSITY_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:43:14'),
(106, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Route added to BRAC University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:44:26'),
(107, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Bus added to BRAC University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:44:47'),
(108, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Schedule deleted successfully.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 18:54:14'),
(109, 'UNIVERSITY_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 19:18:53'),
(110, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Bus added to BRAC University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 19:32:51'),
(111, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Bus added to BRAC University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 19:33:33'),
(112, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Route added to BRAC University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 19:34:12'),
(113, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Bus #13 was assigned to its route.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 19:35:25'),
(114, 'UNIVERSITY_ADMIN', 1, 'ADMIN_ACTION', 'Evening schedule created for BRAC University.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 19:35:36'),
(115, 'PASSENGER', 2, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 19:36:10'),
(116, 'PASSENGER', 2, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 20:00:04'),
(117, 'UNIVERSITY_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 20:01:35'),
(118, 'SYSTEM_ADMIN', 1, 'LOGIN_SUCCESS', 'A successful sign-in was recorded.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-02 20:03:34');
...
(9, 'SYSTEM_ADMIN', 1, '62cce0aa7be53b6ab56e5c73e103f8b4f01867387b6f2cd2fb3d972fbd0a492c', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36',
 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '::1', '2026-09-02 18:42:26', '2026-09-02 18:42:26', '2026-09-02 18:42:52'),
(50, 'UNIVERSITY_ADMIN', 1, '14ad0c1098ac320c27315399cd4273689ad89dd35509db3f9615ff1b958083a7', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '::1', '2026-09-02 18:43:14', '2026-09-02 19:15:49', '2026-09-02 19:15:53'),
(51, 'UNIVERSITY_ADMIN', 1, 'bb756fbdc5f94c6cde272f66d96214062cd0f1e926fe7140e5ede356a28cc6fb', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '::1', '2026-09-02 19:18:53', '2026-09-02 19:35:36', '2026-09-02 19:35:47'),
(52, 'PASSENGER', 2, '841782c10c7991831d35398c295bef72bdcce1c4962fc9c0a547559958824350', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '::1', '2026-09-02 19:36:10', '2026-09-02 19:36:10', '2026-09-02 19:36:47'),
(53, 'PASSENGER', 2, 'c3d611292254beab823842a1a04e680c7fab804156e8354df6dd30c1d429ffe2', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '::1', '2026-09-02 20:00:04', '2026-09-02 20:00:04', '2026-09-02 20:01:24'),
(54, 'UNIVERSITY_ADMIN', 1, '9ab7ea00893eef2cc77752b797279ca4eeb2f06b5afc447a08437039c30e23ae', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '::1', '2026-09-02 20:01:35', '2026-09-02 20:01:35', '2026-09-02 20:03:14'),
(55, 'SYSTEM_ADMIN', 1, '05f10f261f03e442ab39da408dc78ce6e70ad686383b379c97a0f26e399955ae', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '::1', '2026-09-02 20:03:34', '2026-09-02 20:05:12', NULL);
...
ALTER TABLE `announcements`
  ...
  ADD KEY `idx_announcement_tenant_status` (`university_id`,`status`,`published_at`),
  ADD KEY `idx_announcement_creator` (`created_by`);
...
ALTER TABLE `bus_route_assignments`
  ...
  ADD UNIQUE KEY `uq_active_assignment_bus` (`active_bus_key`),
...
ALTER TABLE `password_reset_tokens`
  ...
  ADD KEY `idx_reset_account` (`account_type`,`account_id`),
...
ALTER TABLE `route_stops`
  ...
  ADD KEY `idx_stop_route_status` (`route_id`,`status`);
...
ALTER TABLE `schedules`
  ...
  ADD UNIQUE KEY `uq_bus_date_shift` (`bus_id`,`schedule_date`,`shift_name`),
  ...
  ADD KEY `idx_route_date_shift` (`route_id`,`schedule_date`,`shift_name`);
...
ALTER TABLE `semester_bills`
  ...
  ADD KEY `idx_bill_university` (`university_id`,`semester_id`);
...
--
ALTER TABLE `university_users`
  MODIFY `university_user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `user_profiles`
  MODIFY `profile_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=297;

--
-- AUTO_INCREMENT for table `user_security_events`
--
ALTER TABLE `user_security_events`
  MODIFY `security_event_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;

--
-- AUTO_INCREMENT for table `user_sessions`
--
ALTER TABLE `user_sessions`
  MODIFY `session_record_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `announcements`
  ADD CONSTRAINT `fk_announcement_creator` FOREIGN KEY (`created_by`) REFERENCES `university_users` (`university_user_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_announcement_university` FOREIGN KEY (`university_id`) REFERENCES `universities` (`university_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `route_stops`
  ADD CONSTRAINT `fk_stop_route` FOREIGN KEY (`route_id`) REFERENCES `routes` (`route_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `semester_bills`
  ...
  ADD CONSTRAINT `fk_bill_university` FOREIGN KEY (`university_id`) REFERENCES `universities` (`university_id`) ON DELETE SET NULL ON UPDATE CASCADE;
